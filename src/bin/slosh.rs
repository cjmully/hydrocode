...
// Using rigid particles does not work, so we will be using Signed Distance Functions to determine boundaries
...
fn main() {
    ...
    let radius: f32 = 0.3;
    let latitude_segments = 200;
    let longitude_segments = 200;
    let mass = 1.0;
